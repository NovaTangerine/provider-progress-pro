      ...
      <div className="flex items-start justify-between">
        <div className="w-full">
          <div className="flex items-center gap-3 mb-1">
            <h1 className="text-2xl text-[#333333] font-medium tracking-[-0.04em]">{role.title}</h1>
            <Badge className={`text-xs font-medium capitalize ${urgencyStyles[role.urgency]}`}>
              {role.urgency}
            </Badge>
          </div>
          <div className="mt-3 w-fit rounded-lg sm:rounded-none bg-[hsl(0_0%_97.5%)] dark:bg-[hsl(0_0%_12%)] border border-[hsl(0_0%_92%)] dark:border-[hsl(0_0%_18%)] sm:border-y-0 p-4">
            {details}
          </div>
        </div>
      </div>
