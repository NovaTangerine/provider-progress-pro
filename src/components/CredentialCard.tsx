...
export function CredentialCard({ credential, onClick }: CredentialCardProps) {
  return (
    <button
      ...
      className="w-full max-w-[640px] text-left px-4 py-3 rounded-lg border border-border bg-card hover:border-primary/20 hover:bg-muted/50 transition-all duration-150 group"
    >
