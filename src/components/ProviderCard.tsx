  ...
  return (
    <>
      <div className="group/card rounded-lg border border-border bg-card shadow-sm hover:shadow-md hover:border-border/80 outline outline-0 hover:outline-[0.5px] outline-foreground/20 -outline-offset-1 transition-[box-shadow,border-color,outline-width] duration-200 overflow-hidden grid grid-rows-subgrid row-span-4 gap-0">
        ...
        <div className="px-7 space-y-3 pt-[20px] pb-[14px]">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3 text-sm">
              ...
              <span className="text-lg tracking-tight text-[#333333] font-normal transition-[font-weight] duration-200 group-hover/card:font-medium">{formatDateRange(provider.availability.startDate, provider.availability.endDate)}</span>
        ...
        {/* Provider Highlights */}
        <div className={`px-7 space-y-3 ${highlights.length > 0 ? 'border-t border-dashed border-border/50' : ''} py-[20px]`}>
          {highlights.length > 0 ?
          <>
              <h4 className="text-[10px] uppercase tracking-widest font-medium text-[#909cad] bg-card pr-3 inline-block relative -top-[8px] -mb-[8px]">
                Provider Highlights
              </h4>
              <div
        ...
        {/* Credentials */}
        <div className="px-7 space-y-3 border-t border-dashed border-border/50 py-[20px] pb-[24px]">
          <h4 className="text-[10px] uppercase tracking-widest font-medium text-[#909cad] bg-card pr-3 inline-block relative -top-[8px] -mb-[8px]">
            Credentials
          </h4>
