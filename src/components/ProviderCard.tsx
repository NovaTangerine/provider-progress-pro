  ...
  return (
    <>
      <div className="group/card rounded-lg border border-border bg-card shadow-sm hover:shadow-md hover:border-border/80 outline outline-0 hover:outline-[0.5px] outline-foreground/20 -outline-offset-1 transition-[box-shadow,border-color,outline-width] duration-200 overflow-hidden grid grid-rows-subgrid row-span-4 gap-0">
        ...
        <div className="px-7 space-y-2 pt-[24px] pb-[14px]">
        ...
        {/* Provider Highlights */}
        <div className={`px-7 ${highlights.length > 0 ? 'border-t border-dashed border-border/[0.72] relative' : ''} pt-[18px] pb-[36px]`}>
          {highlights.length > 0 ?
          <>
        ...
        {/* Credentials */}
        <div className="px-7 space-y-2 border-t border-dashed border-border/[0.72] relative pt-[16px] pb-[24px]">
          <h4 className="text-[10px] uppercase tracking-widest font-medium text-[#909cad] bg-card px-3 absolute -top-[8px] left-4">
            Credentials
          </h4>
