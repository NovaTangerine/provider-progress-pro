        ...
        <div className="px-7 space-y-3 pt-[20px] pb-[20px]">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3 text-sm">
              ...
              <span className="text-lg tracking-tight text-[#333333] transition-[font-weight,color] duration-200 font-medium group-hover/card:font-semibold group-hover/grid:text-[#757575] group-hover/card:!text-[#333333]">{formatDateRange(provider.availability.startDate, provider.availability.endDate)}</span>
