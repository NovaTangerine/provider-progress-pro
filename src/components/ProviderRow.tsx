  ...
  return (
    <>
      ...
      >
        ...
        <td className="px-4 py-3">
          <span className="text-sm text-muted-foreground group-hover:[text-shadow:0_0_0.3px_currentColor] transition-all duration-150 flex items-center gap-1.5">
        ...
        <td className="px-4 py-3">
          {currentExp && (
            <p className="text-sm text-muted-foreground group-hover:[text-shadow:0_0_0.3px_currentColor] transition-all duration-150 truncate max-w-[200px]">
